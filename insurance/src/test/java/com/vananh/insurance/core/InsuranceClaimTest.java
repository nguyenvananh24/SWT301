...
public class InsuranceClaimTest {
    ...
    @BeforeEach // phương thức này chạy trước mỗi test, giúp mỗi test độc lập không bị ảnh hưởng bởi test trước
    void setUp() {
        claim = new InsuranceClaim("C001", 1000.0);
    }

    @Test
    @DisplayName("Constructor initializes correctly") // mô tả dễ đọc khi chạy test
